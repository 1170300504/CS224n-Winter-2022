\usepackage{amssymb}\graphicspath{ {images/} }
...
\begin{parts}
    ...
    \label{q_avg_of_two}
    Instead of focusing on just one vector $v_j$, a Transformer model might want to inco,xrporate information from \textit{multiple} source vectors.
