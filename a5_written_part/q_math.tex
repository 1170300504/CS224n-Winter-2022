\usepackage{hyperref}
\usepackage{amsmath}\titledquestion{Attention exploration}[22]
\label{sec:analysis}
...
\begin{parts}
    ...
    \begin{subparts}
        ...
        \begin{answer}
            ...
            So $q = \beta (k_a + k_b)$ suffices, where $\beta \gg 0$ (large scalar multiple).
        \end{answer}
    \end{subparts}
    ...
    \begin{subparts}
        ...
        \begin{answer}
            ...
            So $q = \beta (k_a + k_b)$ suffices, where $\beta \gg 0$.
        \end{answer}
