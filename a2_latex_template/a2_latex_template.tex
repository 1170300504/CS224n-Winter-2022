...
% Question 1-D
        ...
        \begin{shaded}
            \begin{answer}
                \begin{aligned}
                    &\frac{\partial \bm J_{\text{naive-softmax}}(\bm v_c, o, \bm U)}{\partial \bm{U}} = (\hat{\bm{y}} - \bm{y})^\top \bm{v_c} \\
                    &\frac{\bm{J(\bm{v_c}, o, U)}}{\partial \bm{u_i}} = (\hat{\bm{y_i}}-\bm{y_i}) \bm{v_c}
                \end{aligned}
            \end{answer}
        \end{shaded}
            ...
            \begin{answer}
                \begin{enumerate}
                    ...
                    \begin{aligned}
                        ...
                        &= -(1-\sigma(\bm{u_o}^\top\bm{v_c}))\bm{u_o} + \sum_{k=1}^{K} (1-\sigma(-\bm{u_k}^\top\bm{v_c}))\bm{u_k}
                    \end{aligned}
                    \begin{aligned}
                        \frac{\partial \bm J {\text{neg-sample} } (\bm{v_c}, o, \bm{U}) }{\partial \bm{u_o}} = \frac{\partial (-\log(\sigma(\bm{u_o}^\top\bm{v_c})))}{\partial \bm{u_o}} = - (1-\sigma(\bm{u_o}^\top\bm{v_c})) \bm{v_c}\label{eq:equation2}
                    \end{aligned}
                    \begin{aligned}
                        \frac{\partial \bm J {\text{neg-sample} } (\bm{v_c}, o, \bm{U}) }{\partial \bm{u_{w_s}}} = \frac{\partial (-\log(\sigma(-\bm{u_{w_s}}^\top\bm{v_c})))}{\partial \bm{u_{w_s}}} = - (1-\sigma(-\bm{u_{w_s}}^\top\bm{v_c})) \bm{v_c}\label{eq:equation3}
                    \end{aligned}
                    \item
                \end{enumerate}
            \end{answer}
